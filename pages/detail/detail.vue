			...
			<scroll-view scroll-y="true">
				...
				<view class="detail-lyric">
					<view class="detail-lyric-wrap" :style="{transform:'translateY('+ -(lyricIndex -1)*82 +'rpx)'}">
						<!-- <view class="detail-lyric-item">测试问</view> -->
						<view class="detail-lyric-item" v-for="(item,index) in songLyric"
						:key="index" :class="{ active: lyricIndex== index}">{{item.lyric}}</view>
					</view>
				</view>
				<view class="detai-like">
					<view class="detai-like-head">喜欢这首歌的人也听</view>
					...
					<view class="detail-comment-item" v-for="(item,index) in songComment" :key="index">
						...
						<view class="detail-comment-content">
							<view class="detail-comment-title">
								...
								<text class="iconfont icon-icon"></text></view>
							</view>
	...
	export default {
		...
		methods: {
			getMusic(songId){
				...
				songLyric(songId),songUrl(songId)]).then(res=>{
...
<style scoped>
	.detail-play{width: 580rpx;height: 580rpx;background: url(~@/static/disc.png);
	background-size: cover;margin: 214rpx auto 0 auto;position: relative;}
	.detail-play image{width: 370rpx;height: 370rpx;border-radius: 50%;
	...
	.detail-play text{width: 100rpx;font-size: 100rpx;height:100rpx;color: white;position:absolute;left: 0;
	right: 0;bottom: 0;top: 0;margin: auto;}
	.detail-play view{width: 230rpx;height: 360rpx;background: url(~@/static/needle.png);
	position: absolute;left: 100rpx;right: 0;margin: auto;background-size: cover;top: -200rpx;}
	...
	.detai-like{margin: 0 30rpx;}
	.detai-like-head{font-size: 36rpx;color: white;margin: 50rpx 0;
	}
	.detai-like-item{display: flex;align-items: center;margin-bottom: 28rpx;}
	.detai-like-item text{font-size: 50rpx;color: #c6c2bf;}
	.detai-like-img{width: 82rpx;height: 82rpx;border-radius: 20rpx;overflow: hidden;
	margin-right: 20rpx;}
	.detai-like-img image{width: 100%;height: 100%;}
	.detai-like-song{flex: 1;color: #c6c2bf;}
	.detai-like-song view:nth-child(1){font-size: 28rpx;color: white;
	margin-bottom: 12rpx;}
	.detai-like-song view:nth-child(2){font-size: 22rpx;}
	.detai-like-song image{width: 26rpx;height: 20rpx;margin-right: 10rpx;}
	...
	.detail-comment-img{width: 64rpx;height: 64rpx;border-radius: 50%;
	overflow: hidden;margin-right: 18rpx;}
	...
	.detail-comment-text{font-size: 28rpx;line-height: 40rpx;color: white;
	margin-top: 20rpx;border-bottom: 1rpx #e0e0e0 solid;padding-bottom: 40rpx;}
</style>
